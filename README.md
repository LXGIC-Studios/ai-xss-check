...
![npm](https://img.shields.io/npm/v/ai-xss-check)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-xss-check)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# XSS vulnerability detection and prevention tools

XSS vulnerability checker. Scans code for cross-site scripting security issues.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-xss-check.svg)](https://badge.fury.io/js/ai-xss-check)
